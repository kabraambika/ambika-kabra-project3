...
function EditPost({postId, onCancel}) {
    ...
    // on click on done icon, this function is called
          ...
          <form className="edit-post-form">
                <div className="edit-post-form-field">   
                    ...
                    <div className="edit-post-form-btn">
                        ...
                        <DoneOutline className="save-changes-icon" onClick={saveChanges}/> 
                        <CancelOutlined onClick={onCancel}/>
                    </div>
                </div>
            </form>
        </div>
